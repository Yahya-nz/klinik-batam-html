let dataPasien = [
  { id:'P001', nama:'Andi Pratama', nim:'NIM4311901001', prodi:'Teknik Informatika', tgl:'2002-01-12', gender:'L', hp:'08123456789', role:'Mahasiswa', status:'Aktif' },
  { id:'P002', nama:'Siti Rahayu', nim:'NIM4311901045', prodi:'Sistem Informasi', tgl:'2001-03-22', gender:'P', hp:'08234567890', role:'Mahasiswa', status:'Aktif' },
  { id:'P003', nama:'Budi Santoso', nim:'NIP198001012010', prodi:'Unit Kemahasiswaan', tgl:'1980-01-01', gender:'L', hp:'08345678901', role:'Staff', status:'Aktif' },
  { id:'P004', nama:'Maya Lestari', nim:'NIM4311902012', prodi:'Teknik Elektro', tgl:'2002-07-07', gender:'P', hp:'08456789012', role:'Mahasiswa', status:'Aktif' },
  { id:'P005', nama:'Rizki Hidayat', nim:'NIP197505152008', prodi:'Manajemen Bisnis', tgl:'1975-05-15', gender:'L', hp:'08567890123', role:'Dosen', status:'Aktif' },
];

let dataDokter = [
  { id:'D001', nama:'dr. Sarah Amalia', spesialis:'Umum', hari:'Sen-Rab', jam:'08:00 - 12:00', jadwal:'Sen-Rab 08:00-12:00', ruangan:'Ruang 1', sip:'SIP.001', status:'Aktif' },
  { id:'D002', nama:'dr. Rizal Hamdan', spesialis:'Gigi', hari:'Sel-Kam', jam:'13:00 - 17:00', jadwal:'Sel-Kam 13:00-17:00', ruangan:'Ruang 2', sip:'SIP.002', status:'Aktif' },
  { id:'D003', nama:'dr. Maya Sari', spesialis:'Umum', hari:'Rab-Jum', jam:'08:00 - 12:00', jadwal:'Rab-Jum 08:00-12:00', ruangan:'Ruang 3', sip:'SIP.003', status:'Aktif' },
];
...
let dataTransaksi = [
  ...
  { id:'TRX004', nama:'Maya Lestari', pasien:'Maya Lestari', layanan:'Laboratorium', total:25000, metode:'Bayar', status:'Lunas', tgl:'02/03/2024' },
];
...
function genId(prefix, arr, field = 'id') {
  const nums = arr.map(x => { const m = x[field].match(/\d+$/); return m ? parseInt(m[0]) : 0; });
  const next = (nums.length ? Math.max(...nums) : 0) + 1;
  return prefix + String(next).padStart(3, '0');
}

// Helper: format tanggal DD/MM/YYYY dari input date
function fmtTgl(val) {
  if (!val) return '-';
